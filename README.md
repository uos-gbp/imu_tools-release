## imu_tools (noetic) - 1.2.7-1

The packages in the `imu_tools` repository were released into the `noetic` distro by running `/usr/bin/bloom-release imu_tools --rosdistro noetic` on `Tue, 29 Apr 2025 13:24:15 -0000`
...
## imu_tools (noetic) - 1.2.6-1

The packages in the `imu_tools` repository were released into the `noetic` distro by running `/usr/bin/bloom-release imu_tools --rosdistro noetic -y` on `Fri, 12 Jan 2024 12:13:28 -0000`
...
## imu_tools (melodic) - 1.2.5-1

The packages in the `imu_tools` repository were released into the `melodic` distro by running `/usr/bin/bloom-release imu_tools --rosdistro melodic -y` on `Tue, 23 Aug 2022 13:44:02 -0000`
...
## imu_tools (noetic) - 1.2.5-1

The packages in the `imu_tools` repository were released into the `noetic` distro by running `/usr/bin/bloom-release imu_tools --rosdistro noetic -y` on `Tue, 23 Aug 2022 13:42:13 -0000`
...
## imu_tools (noetic) - 1.2.4-1

The packages in the `imu_tools` repository were released into the `noetic` distro by running `/usr/bin/bloom-release imu_tools --rosdistro noetic -y` on `Tue, 12 Apr 2022 10:50:20 -0000`
...
## imu_tools (melodic) - 1.2.4-1

The packages in the `imu_tools` repository were released into the `melodic` distro by running `/usr/bin/bloom-release imu_tools --rosdistro melodic -y` on `Tue, 12 Apr 2022 10:47:38 -0000`
...
## imu_tools (noetic) - 1.2.3-1

The packages in the `imu_tools` repository were released into the `noetic` distro by running `/usr/bin/bloom-release imu_tools -y --rosdistro noetic` on `Fri, 09 Apr 2021 08:57:11 -0000`
...
## imu_tools (melodic) - 1.2.3-1

The packages in the `imu_tools` repository were released into the `melodic` distro by running `/usr/bin/bloom-release imu_tools -y --rosdistro melodic` on `Fri, 09 Apr 2021 08:53:08 -0000`
...
## imu_tools (melodic) - 1.2.2-1

The packages in the `imu_tools` repository were released into the `melodic` distro by running `/usr/bin/bloom-release imu_tools --ros-distro melodic` on `Mon, 25 May 2020 16:32:17 -0000`
...
The packages in the `imu_tools` repository were released into the `indigo` distro by running `/usr/bin/bloom-release imu_tools --track indigo --rosdistro indigo` on `Tue, 06 Oct 2015 13:50:28 -0000`
